...
export const STORE_ITEMS = [
    // ===== 1. KHO BỘ THẺ CAO CẤP (PREMIUM DECKS) =====
    {
        ...
        fallbackIcon: 'fa-solid fa-book-bookmark',
    ...
    },
    {
        ...
        fallbackIcon: 'fa-solid fa-briefcase',
    ...
    },
    {
        ...
        fallbackIcon: 'fa-solid fa-laptop-code',
    ...
    // ===== 2. VẬT PHẨM HỖ TRỢ HỌC TẬP (POWER-UPS & BUFFS) =====
    {
        ...
        fallbackIcon: 'fa-solid fa-snowflake',
    ...
    },
    {
        ...
        fallbackIcon: 'fa-solid fa-lightbulb',
    ...
    // ===== 3. CYBER THEMES & AURA =====
    {
        ...
        fallbackIcon: 'fa-solid fa-terminal',
        iconBg: 'bg-emerald-500/15 text-emerald-500 border-emerald-500/30',
        ...
        features: ['Theme Aura Cyber Emerald', 'Viền phát sáng huỳnh quang', 'Đổi màu nút bấm và nền vũ trụ ma trận']
    },
    {
        id: 'theme_synthwave',
        ...
        fallbackIcon: 'fa-solid fa-sun',
        iconBg: 'bg-pink-500/15 text-pink-500 border-pink-500/30',
        description: 'Phong cách hoàng hôn Retro Synthwave với sắc hồng tím Laser và hiệu ứng hoàng hôn neon huyền ảo.',
        features: ['Laser Rose Neon Aura', 'Gradient hoàng hôn rực rỡ', 'Hiệu ứng retro synthwave 80s aesthetic']
    },
    ...
    // ===== 4. KHUNG AVATAR & DANH HIỆU =====
    {
        ...
        features: ['Khung avatar lục giác phát sáng neon', 'Hiển thị trên Topbar, Sidebar & Hồ sơ', 'Hiệu ứng xoay vòng năng lượng công nghệ']
    },
    {
        id: 'frame_gold_crown',
        ...
        fallbackIcon: 'fa-solid fa-crown',
        iconBg: 'bg-amber-500/15 text-amber-500 border-amber-500/30',
        description: 'Vương miện hoàng gia mạ vàng 24K tôn vinh những người học kiên trì và xuất sắc nhất.',
        features: ['Vương miện vàng hoàng gia 3D', 'Hiệu ứng hào quang lấp lánh', 'Khẳng định vị thế thủ khoa tối cao']
    }
];
