...
export default {
    setup() {
        ...
        const CURRENT_CACHE_NAME = 'extraquiz-v111';
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <div class="flex items-center gap-2.5">
                            ...
                            <span class="px-1.5 py-0.5 rounded text-[9px] font-black bg-rose-500 text-white uppercase tracking-wider">v113</span><span class="px-2.5 py-0.5 rounded-full text-[10px] font-black bg-rose-100 text-rose-700 uppercase tracking-widest border border-rose-200">Admin Pro v2.0</span>
                        </div>
